...
// Pre-calculate squared distances to avoid expensive Math.sqrt calls in hot loop
...
export default function NeuralMesh() {
    ...
    useFrame((state) => {
        ...
        for (let i = 0; i < PARTICLE_COUNT; i++) {
            ...
            // Only compute Math.sqrt if within radius (Optimization: avoids ~150 sqrt calls/frame)
        ...
        for (let i = 0; i < PARTICLE_COUNT; i++) {
            for (let j = i + 1; j < PARTICLE_COUNT; j++) {
                ...
                // Only compute Math.sqrt if within distance (Optimization: avoids thousands of sqrt calls/frame)
